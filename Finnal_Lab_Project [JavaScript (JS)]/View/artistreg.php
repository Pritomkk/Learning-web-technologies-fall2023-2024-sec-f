            ...
            <td>
                <table align="center" width="50%">
                    <tr>
                        <td>
                            <main>
                                <form method="post" action="../Controller/uaregcheck.php" enctype="multipart/form-data" name="Reg" onsubmit="return Form()">
                                    <fieldset>
                                        <legend><h2>Artist Registration</h2></legend>

                                        <input type="hidden" id="userRole" name="userRole" value="Artist">
                                        ...
                                        I accept the <a href="../View/Terms&ConditionUser.Html">Terms and Conditions</a><br><br>
